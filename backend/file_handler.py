...
def detect_encoding(file_path):
    ...
    try:
        ...
        logger.warning(f"Error detecting encoding {e}. Uisng utf-8")
        return'utf-8'
...
def find_delimiter(file_path):
    ...
    with open(file_path,'r',encoding='utf-8',errors='ignore') as fp:
        ...
        try:
            ...
            delimiter = ","
            logger.warning("There is a error in finding the delimiter")
            logger.info("going with default delimiter ','")
        
        logger.info(f"The current delimiter is {delimiter}")
...
def read_json(file_path):
    ...
    try:
        ...
        if isinstance(data,list):
            ...
            logger.error("Unexpected File format")
            df = -1
    except:
...
def clean_dataframe(df):
    ...
    if unnamed_count == total_cols and total_cols>0:
        ...
        logger.info(f"Found {unnamed_count} unnamed column(s) out of {total_cols} - keeping them as legitimate data columns")
...
def open_file(file_path):
    ...
    try:
        ...
        logger.error(f"Error in opening the file {file_path}")
        return None
